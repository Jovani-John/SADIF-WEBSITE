...
export const projects: Project[] = [
  {
    ...
    description:
      "تصميم مول تجاري فاخر يجمع بين الحداثة والراحة، مع مساحات واسعة وممرات تسوق مفتوحة",
    descriptionEn:
      "A luxurious mall design combining modernity and comfort, with spacious areas and open shopping corridors",
    details:
      "مشروع مول تجاري متكامل بتصميم عصري يضم متاجر متنوعة، مناطق ترفيه، مطاعم، ومساحات خضراء مهيأة للزوار",
    detailsEn:
      "A fully integrated commercial mall project with a contemporary design featuring diverse shops, entertainment areas, restaurants, and visitor-friendly green spaces",
    // area: '1200 م²',
    client: "",
  },
  {
    ...
    description:
      "تصميم معماري حديث لفيلا فاخرة، يجمع بين الجمالية والراحة مع استغلال مثالي للمساحات.",
    descriptionEn:
      "Modern architectural design for a luxury villa, combining aesthetics and comfort with optimal space utilization.",
    details:
      "شمل المشروع تصميم الواجهة الخارجية، المساحات الداخلية، الحدائق والمرافق الخاصة، مع الاهتمام بأدق التفاصيل لتوفير تجربة معيشية متكاملة.",
    detailsEn:
      "The project included the exterior facade, interior spaces, gardens, and private amenities, focusing on fine details to provide a complete living experience.",
  ...
  },
  {
    ...
    description:
      "تصميم معماري متكامل لمول تجاري حديث، يجمع بين المساحات المفتوحة والمحلات التجارية بطريقة منظمة وجذابة.",
    descriptionEn:
      "Comprehensive architectural design for a modern shopping mall, combining open spaces and retail stores in an organized and attractive manner.",
    details:
      "يشمل المشروع تصميم واجهات مجمع تجاري، توزيع المحلات، المساحات العامة، المرافق والخدمات مع مراعاة تجربة الزائر وسهولة الحركة داخل مجمع تجاري.",
    detailsEn:
      "The project includes the mall facades, store layout, public areas, facilities, and services, ensuring a smooth visitor experience and easy navigation within the mall.",
    client: "",
  },
  {
    id: "23",
    ...
    description:
      "تصميم معماري لمسجد حديث يجمع بين الطابع الإسلامي التقليدي واللمسات المعاصرة مع الاهتمام بالمساحات الداخلية والخارجية.",
    descriptionEn:
      "Architectural design for a modern mosque that combines traditional Islamic elements with contemporary touches, focusing on both interior and exterior spaces.",
    details:
      "يشمل المشروع تصميم قاعات الصلاة، المآذن، الساحات الخارجية، مرافق الوضوء والخدمات مع مراعاة راحة المصلين وسهولة الحركة داخل المسجد.",
    detailsEn:
      "The project includes the design of prayer halls, minarets, outdoor courtyards, ablution facilities, and services, ensuring comfort and smooth circulation for worshippers.",
    client: "MOSQUE",
  },
  {
    id: "20",
    ...
    description:
      "مشروع تصميم معماري لمبنى حديث يجمع بين الجمال الوظيفي والتصميم العصري مع مراعاة التوازن بين المساحات الداخلية والخارجية.",
    descriptionEn:
      "Architectural design for a modern building that combines functional aesthetics with contemporary design, maintaining a balance between interior and exterior spaces.",
    details:
      "يشمل المشروع تخطيط المساحات الداخلية، الواجهات، المرافق، والمساحات الخارجية، مع التركيز على توفير بيئة عملية وجمالية في الوقت نفسه.",
    detailsEn:
      "The project includes interior layouts, facades, facilities, and outdoor spaces, focusing on creating a functional and aesthetically pleasing environment.",
    client: "ALHAWAN",
  },

  {
    ...
    description:
      "تصميم حدائق مبتكر يجمع بين الجمال الطبيعي والاستدامة لتوفير بيئة هادئة وجذابة",
    descriptionEn:
      "Innovative landscape design combining natural beauty and sustainability to create a serene and attractive environment",
    details:
      "يشمل المشروع مساحات خضراء، ممرات مشاة، مناطق جلوس، ونوافير لإضفاء تجربة ترفيهية وجمالية للزوار",
    detailsEn:
      "The project includes green spaces, walking paths, seating areas, and fountains to provide a recreational and aesthetic experience for visitors",
    client: "JYC",
  },

  {
    ...
    description:
      "تصميم حدائق مبتكر يجمع بين الجمال الطبيعي، المسبح والجراج لتوفير بيئة متكاملة وجذابة",
    descriptionEn:
      "Innovative landscape design combining natural beauty, a swimming pool, and a garage to create a complete and attractive environment",
    details:
      "يشمل المشروع مساحات خضراء، ممرات، مناطق جلوس، مسبح، وجراج للسيارات لتجربة متكاملة تجمع بين الاسترخاء والوظائف العملية",
    detailsEn:
      "The project features green spaces, pathways, seating areas, a swimming pool, and a garage, offering a complete experience combining relaxation and functionality",
    client: "Almuhaideb",
  },

  {
    ...
    description:
      "حديقة خضراء مستدامة بتصميم عصري يوازن بين الجمال الطبيعي والوظائف العملية",
    descriptionEn:
      "Sustainable green garden with a modern design balancing natural beauty and functionality",
    details:
      "يشمل المشروع مساحات خضراء واسعة، ممرات، مناطق جلوس، ونوافير لتجربة استرخاء وجمال طبيعي متكاملة",
    detailsEn:
      "The project features extensive green spaces, pathways, seating areas, and fountains for a complete natural and relaxing experience",
    client: "Al Babtain",
  },

  {
    ...
    description:
      "تصميم داخلي عصري وفاخر يجمع بين الراحة والأناقة في كل زاوية من الفيلا",
    descriptionEn:
      "Modern and luxurious interior design combining comfort and elegance in every corner of the villa",
    details:
      "تتميز الفيلا بمساحات واسعة، غرف معيشة أنيقة، مطبخ مجهز، وغرف نوم فاخرة مع إضاءة وتصميم دقيق",
    detailsEn:
      "The villa features spacious areas, elegant living rooms, a fully equipped kitchen, and luxurious bedrooms with precise lighting and design",
    client: "Private villa",
  },

  {
    ...
    description:
      "تصميم داخلي عصري وفاخر يجمع بين الأناقة والوظائف العملية لكل مساحة في الفيلا",
    descriptionEn:
      "Modern and luxurious interior design combining elegance and functional spaces throughout the villa",
    details:
      "تتميز الفيلا بمساحات واسعة، غرف معيشة فخمة، مطبخ مجهز بالكامل، وغرف نوم أنيقة مع إضاءة مدروسة وتصميم دقيق",
    detailsEn:
      "The villa features spacious areas, luxurious living rooms, a fully equipped kitchen, and elegant bedrooms with carefully planned lighting and design",
    client: "Private villa",
  },

  {
    ...
    description:
      "تصميم داخلي عصري لغرفة فندقية يجمع بين الراحة والأناقة في مساحة محدودة",
    descriptionEn:
      "Modern interior design for a hotel room, combining comfort and elegance within a compact space",
    details:
      "الغرفة تشمل سرير فاخر، منطقة جلوس، إضاءة مدروسة، وحلول تخزين عملية لتجربة إقامة مريحة",
    detailsEn:
      "The room features a luxurious bed, seating area, well-planned lighting, and practical storage solutions for a comfortable stay",
    client: "Hotel Room",
  },

  {
    ...
    description:
      "تصميم داخلي عصري لشقق سكنية في عمائر متعددة الطوابق يجمع بين الأناقة والوظائف العملية",
    descriptionEn:
      "Modern interior design for residential apartments in multi-story buildings, combining elegance with functional spaces",
    details:
      "يشمل المشروع تصميم غرف المعيشة، المطابخ، غرف النوم، وحلول التخزين بطريقة عملية وفاخرة لتوفير تجربة سكنية مريحة",
    detailsEn:
      "The project includes the design of living rooms, kitchens, bedrooms, and storage solutions in a practical and luxurious way to offer a comfortable living experience",
  ...
  },
  {
    ...
    description:
      "تصميم داخلي حديث لشقة سكنية يجمع بين البساطة والفخامة مع توزيع عملي للمساحات يمنح إحساساً بالراحة والاتساع.",
    descriptionEn:
      "Modern interior design for a residential flat, combining simplicity and elegance with a practical space layout that enhances comfort and openness.",

    details:
      "يشمل المشروع تصميم غرفة المعيشة، غرفة الطعام، المطبخ، غرف النوم، والحمامات، مع توظيف إضاءة مدروسة ومواد عالية الجودة لخلق بيئة سكنية مريحة ومتناسقة.",
    detailsEn:
      "The project includes the design of the living room, dining area, kitchen, bedrooms, and bathrooms, featuring well-planned lighting and high-quality materials to create a comfortable and harmonious living environment.",
  ...
  },
  {
    ...
    description:
      "تصميم داخلي متكامل لشقة سكنية في حي المطلقية بمدينة الرياض، يجمع بين البساطة العصرية واللمسات الفاخرة. تم التركيز على خلق بيئة مريحة ومتناسقة في جميع الفراغات مع استخدام ألوان هادئة وخامات عالية الجودة تعكس هوية المكان وراحة المستخدم.",
    descriptionEn:
...

  {
    ...
    description:
      "شقة دانا تتميز بتصميم داخلي عصري يجمع بين البساطة والفخامة. تم التركيز على توزيع الإضاءة الطبيعية واستغلال المساحات لتحقيق أعلى درجات الراحة والانسجام في كل زاوية داخل الشقة.",
    descriptionEn:
      "Dana Apartment features a modern interior design that blends simplicity with elegance. The layout maximizes natural lighting and optimizes the use of space to create a comfortable and harmonious living environment.",

    details:
      "• تصميم عصري بألوان هادئة\n• توزيع مثالي للإضاءة الطبيعية\n• دمج بين الخشب والرخام لإضافة فخامة\n• أثاث عملي يناسب المساحات\n• تشطيب عالي الجودة",
    detailsEn:
      "• Modern design with soft, neutral tones\n• Optimal natural lighting distribution\n• Combination of wood and marble for a luxurious touch\n• Functional furniture tailored to the space\n• High-quality finishing materials",
  ...
  // },
  {
    ...
    description:
      'تصميم داخلي عصري لكافيه "Lungo" يركز على خلق أجواء مريحة وعصرية للزبائن. تم اختيار ألوان دافئة وإضاءة موجهة لتسليط الضوء على التفاصيل، مع توزيع المساحات بشكل عملي لاستيعاب الزبائن مع الحفاظ على خصوصية كل منطقة.',
    descriptionEn:
      'Modern interior design for "Lungo" café, focusing on creating a comfortable and contemporary atmosphere. Warm colors and targeted lighting highlight design details, while the layout efficiently accommodates guests and maintains privacy in each area.',

    details:
      "• تصميم عصري مع لمسات دافئة\n• توزيع إنارة مخصص لإبراز التفاصيل والجو العام\n• أثاث عملي ومريح للزبائن\n• دمج خامات طبيعية مثل الخشب والحجر\n• استغلال المساحة بشكل مثالي لاستيعاب الزبائن",
    detailsEn:
      "• Contemporary design with warm touches\n• Custom lighting layout to enhance ambiance and details\n• Comfortable and functional furniture for guests\n• Use of natural materials like wood and stone\n• Optimal space utilization to accommodate visitors",
...

  {
    ...
    description:
      "تصميم داخلي عصري ومتعدد الوظائف لصالة رياضية متكاملة في الرياض، مع التركيز على الإضاءة والتهوية والمساحات المفتوحة.",
    descriptionEn:
      "Modern and functional interior design for a fully equipped gym in Riyadh, emphasizing lighting, ventilation, and open spaces.",

    details:
      "تم تصميم الصاله رياضة ليشمل مناطق تدريب متنوعة، أجهزة حديثة، منطقة للكارديو، ومساحات مفتوحة لتمارين جماعية، مع اختيار ألوان ومسطحات تعكس الطاقة والحيوية.",
    detailsEn:
      "The gym is designed to include diverse training zones, modern equipment, a cardio area, and open spaces for group exercises, with a color palette and surfaces that reflect energy and vitality.",
...

  {
    ...
    description:
      "تصميم داخلي عصري لكافيه يركز على الأجواء المريحة والإضاءة الدافئة والمساحات المفتوحة لتجربة مميزة للزوار.",
    descriptionEn:
      "Modern interior design for a café, focusing on cozy ambiance, warm lighting, and open spaces to create a unique experience for visitors.",

    details:
      "تم تصميم الكافيه ليشمل مناطق جلوس متنوعة، ركن للقهوة والمشروبات، ومساحات تفاعلية للزوار، مع استخدام ألوان ومواد تعكس الأناقة والراحة.",
    detailsEn:
      "The café features various seating areas, a coffee and beverage corner, and interactive spaces for visitors, using colors and materials that reflect elegance and comfort.",
  ...
  },
  {
    ...
    description:
      "كافيه بتصميم عصري مكون من دورين، يوفر أجواء مريحة مع توزيع ذكي للمساحات والإضاءة لتعزيز تجربة الزوار.",
    descriptionEn:
      "A modern two-story café designed to offer a cozy atmosphere, with smartly distributed spaces and lighting to enhance the visitor experience.",

    details:
      "يحتوي الكافيه على مناطق جلوس متعددة في كلا الدورين، ركن للقهوة والمشروبات، مع تصميم داخلي يركز على الراحة والأناقة وخلق تجربة فريدة للزوار.",
    detailsEn:
      "The café features multiple seating areas across both floors, a coffee and beverage corner, with interior design focusing on comfort and elegance to create a unique experience for visitors.",
...

  {
    ...
    description:
      "تصميم داخلي حديث للشركة يشمل المكاتب والمساحات المشتركة بطريقة عملية وجذابة.",
    descriptionEn:
      "Modern interior design for the company, covering offices and shared spaces in a practical and attractive way.",

    details:
      "تم التركيز على خلق بيئة عمل مريحة مع توزيع ذكي للمكاتب ومساحات الاجتماعات، إضافةً إلى تصميم مناطق استقبال مميزة.",
    detailsEn:
      "Focused on creating a comfortable work environment with smart office and meeting room layout, along with a distinctive reception area design.",
